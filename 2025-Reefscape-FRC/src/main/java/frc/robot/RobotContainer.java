...
public class RobotContainer {
    ...
    public RobotContainer() 
    {
         ...
         * be used.
         */
        //NamedCommands.registerCommand("Top Coral Score", new CoralElevatorSetPositionCommand(Constants.ElevatorConstants.ELEVATOR_ANGLE_HIGH, coralElevatorSubsystem));
